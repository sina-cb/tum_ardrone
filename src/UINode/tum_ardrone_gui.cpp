...
void tum_ardrone_gui::on_newMap_clicked()
{
    rosThread->publishCommand("n new");
}

void tum_ardrone_gui::on_SaveBtn_clicked()
{
...
{
    rosThread->publishCommand("n prev");
}

void tum_ardrone_gui::on_nextBtn_clicked()
{
    rosThread->publishCommand("n next");
}
